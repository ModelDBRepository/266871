...
params.DRNL.linCascade=1; % order of linear gammatone filters
...
params.synapse.GmaxCa=2e-9;% MSR fiber (Sumner et al 2003b)
params.synapse.Ca_thresh=1.4e-11;
